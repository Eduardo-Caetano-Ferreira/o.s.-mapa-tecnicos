...
const rotasMoto = [
    ...
    { nome: "Renan", bairros: ["campos eliseos", "verde mar", "santa terezinha", "loty", "florida mirim", "itaguai", "agenor de campos", "regina maria", "santana", "jardim leonor", "jussara", "itaoca", "jardim praia grande"] },
    { nome: "Clayton", bairros: ["vila seabra", "nossa senhora de fatima", "vila atlantica", "umuarama", "vera cruz", "mongagua", "pedreira", "centro", "vila sao paulo", "vila nova", "praia grande"] },
    { nome: "Augusto", bairros: ["itanhaem", "mongagua"] },
    { nome: "Allan", bairros: ["praia grande"] }
];

const rotasCarro = [
    { nome: "Falar com a torre", bairros: ["peruibe", "praia grande"] },
    ...
    { nome: "Edmilson", bairros: ["jardim praia grande", "oceanopolis", "vila seabra", "nossa senhora de fatima", "vila atlantica", "umuarama", "vera cruz", "mongagua", "pedreira", "centro", "vila sao paulo", "vila nova"] }
];
